...
export const MAX_EVAL = 2; // don't challenge the player if they are already winning by this much. Increase to get more branches.
...
export const ENGINE_RAM_USAGE = 8 * 1024; // in megabytes
